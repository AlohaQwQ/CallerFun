package com.xixi.finance.callerfun.ui.adapter;
...
public class TabsViewpagerAdapter extends FragmentStatePagerAdapter {
    ...
    public TabsViewpagerAdapter(FragmentManager fm, Context context, int pageNumber, List<String> tabTitles, List<Fragment> fragments) {
        super(fm);
