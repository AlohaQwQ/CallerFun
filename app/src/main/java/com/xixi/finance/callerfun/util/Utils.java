...
import com.xixi.finance.callerfun.IMyAidlInterface;
    ...
    public static synchronized void endCall(Context ctx) {
        ...
        try {
           ...
           /* ITelephony iTelephony = null;
            ...
            IMyAidlInterface iTelephony = null;
            LogUtil.biubiubiu("End call.");
            iTelephony = (IMyAidlInterface)getITelephonyMethod.invoke(mTelMgr, (Object[])null);
            iTelephony.endCall();
        } catch (Exception e) {
            e.printStackTrace();
            LogUtil.biubiubiu("Fail to answer ring call.");
        }
    }
