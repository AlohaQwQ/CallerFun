...
public class APIKey {
    ...
    public static final String COMMON_APPLICATION_TYPE = "reqApplicationType";//区分乐宝贷 好又贷
    ...
    public static final String VERSION_REQ_APPLICATION_VERSION = "reqApplicationVersion";//区分乐宝贷 好又贷
    ...
    public static final String ORDER_CONFIRM_IDENTIFY_CODE_BANK_CHOICE_TYPE = "bankChoiceType"; //1.选择已有银行卡，2.新增卡
    ...
    public static final String BORROW_ORDER_PRODUCT_PERIOD = "period"; //期数
    public static final String BORROW_ORDER_PRODUCT_PERIOD_TOTAL = "periodTotal"; //期数
    public static final String BORROW_ORDER_PRODUCT_MONTH_RATE = "monthRate"; //月利率
    public static final String BORROW_ORDER_PRODUCT_MIN_AMOUNT = "minAmount"; //最小额度
    public static final String BORROW_ORDER_PRODUCT_MAX_AMOUNT = "maxAmount"; //最大额度
    public static final String BORROW_ORDER_HANDLE_DATE = "handleDate"; //操作时间
    public static final String BORROW_ORDER_AMOUNT = "amount"; //本金
    public static final String BORROW_ORDER_BORROW_MONEY_PURPOSE = "loadReason"; //信贷理由
    public static final String BORROW_ORDER_PERIOD_TOTAL = "periodTotal"; //期数
    public static final String BORROW_ORDER_PRODUCT_PERIOD_SCOPE = "periodsScope"; //资方限制期数
    public static final String BORROW_PRODUCTS_FIRST_LOGIN = "firstLogin"; //资方限制期数
    public static final String BORROW_PRODUCTS_PRODUCT_TYPE = "productType"; //资方限制期数
    public static final String BORROW_PRODUCTS_CATEGORY_ID = "productCategoryId"; //分类ID
    public static final String BORROW_ORDER_WHITE_BLACK_USER_TYPE = "userType"; //用户黑白灰类型
