...
public class APIKey {
    ...
    /* 录音 */
    public static final String RECORD_IPT_DURATION = "ipt-duration";
    public static final String RECORD_PHONE = "phone";
    public static final String RECORD_IPT_PHONE = "ipt-phone";
    public static final String RECORD_IPT_YEAR = "ipt-year";
    public static final String RECORD_IPT_MONTH = "ipt-month";
    public static final String RECORD_UPLOAD_FILE = "attach";
    public static final String RECORD_ALL_COUNT = "all_count";
    public static final String RECORD_ALL_DURATION = "all_duration";
    public static final String RECORD_THIS_COUNT = "this_count";
    public static final String RECORD_THIS_DURATION = "this_duration";
    public static final String RECORD_THIS_S0 = "this_t60";
    public static final String RECORD_THIS_S60 = "this_t60_180";
    public static final String RECORD_THIS_S180 = "this_t180_360";
    public static final String RECORD_THIS_S360 = "this_t360";
    public static final String RECORD_DETAIL_LIST = "list";
    ...
    public static final String CONFIG_CALL_NUMBER = "callNumber";
    public static final String CONFIG_CALL_CUSTOMER_NAME = "callCustomerName";
    public static final String CONFIG_CALL_STATE = "callState";
