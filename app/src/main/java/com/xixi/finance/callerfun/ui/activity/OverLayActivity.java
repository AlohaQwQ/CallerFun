...
public class OverLayActivity extends Activity {
     ...
     * 挂断电话action
     */
    public static final String ACTION_END_CALL = "com.xixi.finance.callerfun.ACTION_END_CALL";
    ...
    private LinearLayout mEndRingLayout = null;
    /**
     * 城市结果列表
     */
    ...
    //静音按钮
    private Button mEndRingBt = null;
    ...
    private void initView() {
        ...
        mEndRingLayout = (LinearLayout)findViewById(R.id.layout_EndRing);
        // 显示正在加载数据。
        ...
        mEndRingBt = (Button)findViewById(R.id.overlay_end_ring_bt);
    ...
    private void addListener() {
        ...
        mEndRingLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
...
//                am.restartPackage(getPackageName());
        ...
        mEndRingBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
            	AudioManager audio = (AudioManager)getSystemService(Context.AUDIO_SERVICE);
