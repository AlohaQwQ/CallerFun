...
import aloha.shiningstarbase.util.TimeUtil;

/**
 * Created by AlohaQoQ on 2018/2/5.
 */

public class DatePickerkerDialog extends AlertDialog implements DialogInterface.OnClickListener, DatePicker.OnDateChangedListener {
    ...
    public DatePickerkerDialog(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public DatePickerkerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                               int dayOfMonth) {
        super(context, theme);
    ...
    public void setMaxDate(){
        mDatePickerStart.setMaxDate(TimeUtil.getCurrentTimeInMillis());
    }
