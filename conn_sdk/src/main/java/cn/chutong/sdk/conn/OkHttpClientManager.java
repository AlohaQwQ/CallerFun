...
import cn.chutong.sdk.conn.interfaces.IConnectorDatabank;
...
public class OkHttpClientManager
{
     ...
     * @see #commitRequestTask(OkHttpRequest, OkHttpRequestOptions, IResultCallback)
     * @since 0.0.1
     */
    public void commitRequestTask(OkHttpRequest request, IResultCallback mResultCallback) {
        commitRequestTask(request, null, mResultCallback);
    }
     ...
     * @since 0.0.1
     */
    public void commitRequestTask(final OkHttpRequest request, OkHttpRequestOptions options, final IResultCallback mResultCallback) {
        if (!isInit())
        {
            ...
            saveThreadExecutor.submit(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!TextUtils.isEmpty(response)) {
                        ...
                        mOkHttpClient.commitRequestTask(request, finalOptions, mResultCallback);
                    }
                }
            });
        }
     ...
     * @param request 网络请求参数
     * @return 本地缓存数据
     * @see cn.chutong.sdk.common.util.NetworkUtil#isNetworkAvaliable(Context)
